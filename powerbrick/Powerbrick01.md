...
由小喵科技团队设计的一款使Microbit通向乐高的的新电子体系模块。因为模块特别好用，所以我们用了“魔块”这个昵称。
...
1. 解决Microbit拓展展延伸拓展的问题，停留在裸板上的编程的枯燥乏味
...
采用4PIN防反接排线，不用在担心插错，不用再担心插接不良。让课堂接线更加轻松。
...
编程环境怎么少的了喵家的的Kittenblock，在未来几个星期，能量模块Powerbrick就会上线，敬请期待！
...
答：每个套件对应能量魔块+机械塑料件+电气连接线+说明书+模块折页说明书+精美包装盒等，当然还包括喵家精心准备的Powerbrick插件与喵家贴心的服务。

**3.能量魔块套件价位大概多少？**

答：按照小喵的“国际惯例”，新品上架总会有优惠，而且是越早买优惠越大。
.
喵家考虑到各个用户群体的消费能力，我们推出了三款能量魔块套件，新品上架期间，价格分别是499，599，999。
这些价格都不含Microbit和18650锂电池，因为我们考虑到好多老顾客已经有了这些东西，没有必要在花钱再去重复购买。

你问CC喵买哪个最划算，当然是999那个套件，包含以上所有的模块还有配套的东西（机械塑料件+电气连接线+说明书+模块折页说明书+精美包装盒，4个Geekservo舵机，2个Geekservo电机，超值！），可以拼成十种形态。

由于展会的原因，各个套件的渲染图还没来得及出，等展会过后，会在此更新。
