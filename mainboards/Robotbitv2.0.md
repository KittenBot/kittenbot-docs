# Robotbit V2.0详解   
## 扩展板简介   
KittenBot团队专为Microbit量身定做的优秀机器人扩展板。   
## 特色
...
![](./images/08.png)   
或者kittenblock的代码编程模式   
![](./images/07.png)   
以上详细教程可以查看Learn中相关教程或者到爱上小喵科技Q群中进行求助   
...
### 采用全新40P立式microbit插槽，拔插更方便，不伤Microbit金手指。   
### 增加5V和GND各一列排针   
...
Microbit上可编程IO口接近20个，但是很多已经与板子上的点阵按键复用了。考虑到复用带来的不方便性对，新手容易带来无解，小喵引出了8个（跟板子资源没有复用的IO口）已经完全足够应对日常的DIY。如果你对IO数量有狂热的追求，可以选择喵家另外一款扩展板IObit
...
### 电机接口那边的VM有什么用？
平时使用直流电机是用不到VM，直流电机只需要插A+A-或者B+B-。使用4相5线步进电机的时候，刚好VM就用上了，详细看对应的教程
...
### 电路板好像烧坏了，怎么办小喵有保修么？
robotbit在工厂出厂都进行的硬件程序测试，保证了功能的完好性。首先不要怀疑硬件问题   
先排除下是不是确定烧坏了，如果烧坏了小问题，寄回来给小喵，小喵只收取元件的成本费，没有多少钱。具体价格咨询淘宝客服   
根据实际损坏的严重性进行评判   
